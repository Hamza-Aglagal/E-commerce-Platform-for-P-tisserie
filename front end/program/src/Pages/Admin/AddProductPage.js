...
const AddProductPage = () => {
    ...
    const [Name, Img, Price, Desc, Category, Ispress, Loading, onNameChange, onImgChange, onPriceChange, onDescChange, onCategoryChange, handelSubmit, DataCategory] = AddProductHoook()
